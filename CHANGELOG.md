...
### Added
- Tip to use visidata (`vd`) for exploring JSONL output in help text of `list-all`, `list-aspects`, and `list-shortcomings` commands.
- Unit tests to verify the visidata tips are displayed in the help text.
